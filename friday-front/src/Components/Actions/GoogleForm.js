        ...
        return(
            <div className="offcanvas offcanvas-start" tabIndex={-1} id="AddGoogle" aria-labelledby="AddGoogleLabel">
                ...
                <div className="offcanvas-body">
                    ...
                    <button type="button" className="btn btn-dark text-warning form-control" onClick={this.props.onGoogleAdd} data-bs-dismiss="offcanvas" aria-label="Close">Synchronisation<i className="ms-3 fa fa-sync"></i></button>
                </div>
            </div>
        );
    }
